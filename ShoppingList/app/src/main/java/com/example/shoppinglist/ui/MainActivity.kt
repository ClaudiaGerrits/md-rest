...
import com.example.shoppinglist.shoppinglistkotlin.ProductRepository
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getShoppingListFromDatabase() {
        CoroutineScope(Dispatchers.Main).launch {
            ...
            this@MainActivity.productList.clear()
            this@MainActivity.productList.addAll(shoppingList)
